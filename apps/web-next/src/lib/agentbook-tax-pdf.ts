  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        `Generated by AgentBook. Confirmed expenses only (${data.expenseCount}); personal spending excluded. AgentBook prepares this package — you (or your accountant) file it. It is not submitted to the IRS, CRA, or ATO.`,
      ),
