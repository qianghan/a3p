...
The ATO's cents-per-km method applies — a flat rate per kilometre, capped at a maximum annual distance for this method (beyond that, the ATO's logbook method applies, which isn't automated in AgentBook yet).
