...
| Bank sync | Yes | Yes | Not yet — see note below |
...
- **AU bank sync isn't available yet.** Our bank-connection provider doesn't support Australian banks. Log expenses manually or from a receipt photo in the meantime — everything else works normally.
